...
describe("TrieNode", () => {
  ...
  it("should get child nodes", () => {
    ...
    expect((trieNode.getChild("a") as TrieNode).toString()).toBe("a");
    expect((trieNode.getChild("a") as TrieNode).character).toBe("a");
    expect((trieNode.getChild("o") as TrieNode).toString()).toBe("o");
  ...
  it("should NOT delete child node if the child node has children", () => {
    const trieNode = new TrieNode("c");
    trieNode.addChild("a");
    const childNode = trieNode.getChild("a") as TrieNode;
