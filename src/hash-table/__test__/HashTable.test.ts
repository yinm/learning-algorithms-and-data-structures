import HashTable, { HashMap } from "../HashTable";
...
describe("HashTable", () => {
  ...
  it("should set, read and delete data with collisions", () => {
    ...
    const stringifier = (value: HashMap<string>) =>
  ...
  it("should be possible to add objects to hash table", () => {
    ...
    const hashTable = new HashTable<TestObject>();

    hashTable.set("objectKey", { prop1: "a", prop2: "b" });

    const object = hashTable.get("objectKey") as TestObject;
